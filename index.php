...
<body>
          ...
          <button type="button" name="tour" id="introJS" class="btn-gradient">Tour me!</button>
            <div class="help">
                ...
                <div class="sub-text">
                    ...
                    <div class="sub-text">
                      <p>Use the search bar to look up for items, you can either type single or multiple names. Regex should work too.</p>
                      <p>You can search by names or relics like: "oberon|ash" or "axi c1|ash|axi c2"</p>
                      <h4>Pro Tips:</h4>
                      <p>If you sort by NAME the items will group up and the script will sum up the set/part values.</p>
                    ...
                    <div class="sub-text">
                      <h4 class="icon-chart-area">Values Graph</h4>
                      ...
                      <p>Will add a table to the modal with all the values collected trough the time. (A lot of data)</p>
                      <h4 class="icon-terminal">Chat Data</h4>
                      <p>Extends a each row in table with the chat values.</p>
                    </div>
                    ...
                    <div class="sub-text">
                      <p>The website is a PWA (Progressive Web App), that means that you can browse it while offline.</p>
                      <p>
                        If you're using the Values Graph/Table you will notice that when you're browsing the page while beign offline, the table rows will have a <span class="icon-floppy"></span> next to them, or some <span style="color: green">item names</span> will be green.
                        The icon or the color indicate that you have a cached version of the data of that item and even trough you're offline browsing you can check the values table or the graph.
                      </p>
                    </div>
                ...
                <div class="sub-text">
                    ...
                    <h3>How do you get the data?</h3>
                        <p>I use the API of those sites:
                          <ul>
                            <li><a href="https://warframe.market">Warframe.market</a> - Market</li>
                            <li><a href="https://nexus-stats.com/">Nexus-stats</a> - Chat (OCR collected)</li>
                          </ul>
                        </p>
      ...
      <div class="container">
        ...
        <div class="chart" style="display: none;">
          <details class="graph-options details-options">
            ...
            <div class="filters">
              <input type="number" class="graph-number-input" name="daysBack" id="chartDaysBack" value="" min="1" max="365" placeholder="Days back on graph: " list="daysBackList">
          ...
          <canvas id="chart" style="width: 100%; min-height: 400px;"></canvas>
        </div>
  ...
  <header class="meta-header clearfix">
      <nav class="header-part left center-mobile">
        <ul>
                ...
                <div class="dropdown-container">
                    ...
                    <div class="row" data-step="13" data-intro="If this is checked you'll open a modal with a chart of how the values for the item you clicked changed overtime.">
                        <label>
                            ...
                            <div class="text icon-chart-area">Values Graph</div>
                        </label>
                    </div>
          ...
          <li><a href="nojs/sell.html" title="nojs" class="menu-btn icon-print" target="_blank" data-step="18" data-intro="Simple HTML table with no JS at all.">NO&nbsp;JS</a></li>
  ...
  <main>
    ...
    <details class="filters-details" data-step="1" data-intro="You can set your table here.">
      ...
      <div class="filters">
        ...
        <div class="intro-wraper" data-step="3" data-intro="Here you can set from what column should be the DUCAT : PLATINUM ratio calculated from.">
          <hr>
          <h3 class="icon-calculator">CALCULATE RATIO FROM:</h3>
            ...
            <table id="dataTable" width="100%">
              <thead data-step="8" data-intro="Click on any of the column headers to order the table by it. If you order by 'ITEM' that will create groups and the script will sum if you should buy/sell parts or whole sets.">
                <tr>
                  ...
                  <th>MED</th>
                  <th>MODE</th>
                  <th><img src="img/ducats.png" alt="ducats" width="20" height="20" class="icon-vert-middle"></th>
  ...
  <?php
    include("resources/library/Controller/Index.php");
    $index = new Controller\Index($_GET);
    $index->printJSVar();
   ?>
  </script>
